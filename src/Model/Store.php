...
class Store extends AbstractModel
{
    ...
    public function getModelDefinition(): array
    {
        return [
            ...
            'visible' => [ 'model' => OffersCountryCode::class, 'array' => true ],
        ];
    }
    ...
    public function setVisibleCountryCodes(array $countryCodes): void
    {
        $this->visible = array_map(function ($countryCode) {
            return OffersCountryCode::constructFromArray(['countryCode' => $countryCode]);
        }, $countryCodes);
    }

    /**
     * Adds a new OffersCountryCode to visible by countryCode.
     * @param string $countryCode CountryCode for the OffersCountryCode to add.
     */
    public function addVisibleCountryCode(string $countryCode): void
    {
        $this->visible[] = OffersCountryCode::constructFromArray(['countryCode' => $countryCode]);
    }
}
